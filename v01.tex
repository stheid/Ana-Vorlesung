...
\sS{Beispiele}
\begin{enumerate}
\item{\desc{Sei}{$M$ die Menge aller Studierenden in L1\\*
...
\desc{Allgemeiner:}{Sei $l,m \in \N$, $l \le m \le n$\\*$\sum_{k=l}^m a_k = a_l+a_{l+1}+…+a_m$}
Aussage des Satzes:
...
Setze $0!=1$
\item Für $k,n\in \Z$ mit $0\le k \le n$ sei $\\bino{n}{k}:= \frac{n!}{k!·(n-1)!}$ \Rarr{} Binomialkoeffizient\\*
\begin{tabular}{r|c|c|c|c|c|c|c}
n & 0 & 1 & 2 & 3 & 4 & 5 & 6\\* \hline
n! & 1 & 1 & 2 & 6 & 24 & 120 & 720
\end{tabular}
\bsp
$\bino{5}{2} := \frac{5!}{2!· 3!} = \frac{5· 4 ·\cancel{3 · 2 · 1}}{2· 1· \cancel{3· 2}· 1 } = \frac{20}{2}=10$\\*
Bemerkung: $\bino{n}{0}= 1 = \bino{n}{n}$
\end{enumerate}