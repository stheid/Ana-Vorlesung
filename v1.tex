...
\begin{enumerate}
\item Induktionsanfang (IA): n=1 $S(1) = 1 = \frac{1·2}{2}$\marginpar{ok!}
...
Aussage des Satzes:
$\ds \sum_{k=1}^n k = \frac{n(n+1)}{2}$
\\
%\marginpar{
\underline{Kombinatorik} (mathemathisches Zählen)
%}

\underline{\section{Definition}}
