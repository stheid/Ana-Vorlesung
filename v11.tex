...
\desc{Dann $exp(1)$}{$= \underbrace{\frac{1}{n} + ... \frac{1}{n}}_n$\\*
$= exp(\frac{1}{n}) + ... + exp(\frac{1}{n}) = exp(\frac{1}{n})^n$ \\*
$\geq (1 + \e)^n \underset{\overset{\uparrow}{Bernulli}}{\geq} 1 + n \e$}
$exp(1) \geq 1 + n \e$\\*
...
mit $x_n \in D$\\*
\desc{$f, g$ stetig $\Rarr$}{$f(x_n) \to f(x)$ \\*
$g(x_n) \to g(x)$}
\desc{\Rarr}{$f(x_n) + g(x_n) \to f(x) + g(x)$\\*
$f(x_n) \cdot g(x_n) \to f(x) \cdot g(x)$}
Wenn also $f(x) \neq 0$\\*
$f(x_n)^{-1} \to f(x)^{-1}$\\*
