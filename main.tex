...
\cmd{\desc}[2]{\begin{description}\item[\rm#1]{\hfill\\*#2}\end{description}}
\cmd{\enum}[1]{\begin{enumerate}\item{#1}\end{enumerate}}
\cmd{\ind}[2]{\einruck{IA:}{#1\ok}\einruck{IS: }{$n\to n+1$#2\qed}}
\cmd{\indIV}[3]{\einruck{IA:}{#1\ok}\einruck{IV:}{#2}\\\einruck{IS: }{$n\to n+1$#3\qed}}
\cmd{\notat}[1]{\hfill\\{\textsf{\em Notation:}}\vspace{-2.6ex}\begin{addmargin}{.1\textwidth}{\textsf{\em #1}}\end{addmargin}}
