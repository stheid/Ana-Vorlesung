...
\sS{Definition uneigentliches Supremum}
Sei $M \in \R$ eine nicht-leere Teilmenge. Wenn $M$ nach oben unbeschränkt, schreibe $sup(M) = \infty$ (Sprich: uneigentliches Supremum)
...
\desc{Und dann gilt}{$f({x_n}_k) \to y$ für $k \to \infty$ (Teilfolge einer Konvergenten Folge)\\*
$f({x_n}_k)) \to y$ für $k \to \infty$ weil $f$ stetig}
Also $y = f(x)$\\*
