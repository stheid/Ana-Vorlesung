...
\begin{wrapfigure}{r}{0.2\textwidth}
  ...
  \tikz[scale=0.5,domain=-3.5:3.5, samples=200,prefix=plots/,smooth]{
      ...
      \draw[color=red] plot[id=abb1.1] function{x*x} node[below=3.5cm] {\footnotesize $f_1(x) =x^2$};
      \draw[color=blue] plot[id=abb1.2,sharp plot] function{abs(x)} node {{\footnotesize $f_2(x) = |x|$}};
      \draw[color=cyan] plot [id=exp] function{exp(x)} node [below=13.5cm] {\footnotesize $f_2(x) = exp(x)$};
      \draw[color=green!60!black,const plot] plot[id=abb1.5] function{floor(x)} node[below] {\footnotesize $f_5(x) = [x]$};
  }
  \end{center}
\end{wrapfigure}
seien $a, b \in \R$ \\*
